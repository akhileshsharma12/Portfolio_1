...
try {
    var svgCorePackageJson = __turbopack_context__.r("[project]/node_modules/@fortawesome/fontawesome-svg-core/package.json (json)");
    SVG_CORE_VERSION = svgCorePackageJson.version;
} catch (e) {
    // If package.json can't be loaded, try environment variable
    SVG_CORE_VERSION = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.FA_VERSION || '7.0.0-alpha8';
}
...
FontAwesomeIcon.propTypes = {
    ...
    rotateBy: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].bool,
    ...
    widthAuto: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$prop$2d$types$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].bool
};
...
function U(t) {
    return Object.entries(t).filter((param)=>{
        let [, e] = param;
        return e || e === !1;
    }).map((param)=>{
        let [e, r] = param;
...
var h, A = (h = class {
    ...
    captureMessage(e) {
        let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "info", n = arguments.length > 2 ? arguments[2] : void 0;
        this.captureEvent({
            type: "message",
            level: r,
            message: e,
    ...
    sendEvent(e) {
        let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 5e3;
        return x(this, null, function*() {
            try {
    ...
    flush() {
        let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 5e3;
        return x(this, null, function*() {
            try {
...
function H() {
    let { scriptLocation: t, query: e, loadAsync: r = !0, crossOrigin: n, apihost: s = "https://js.hcaptcha.com", cleanup: a = !0, secureApi: u = !1, scriptSource: o = "" } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, c = arguments.length > 1 ? arguments[1] : void 0;
    let i = S(t), f = R(i);
    return new Promise((v, w)=>{
        let m = f.document.createElement("script");
        m.id = L, o ? m.src = "".concat(o, "?onload=").concat(b) : u ? m.src = "".concat(s, "/1/secure-api.js?onload=").concat(b) : m.src = "".concat(s, "/1/api.js?onload=").concat(b), m.crossOrigin = n, m.async = r;
        let T = (E, X)=>{
            try {
        ...
        m.onload = (E)=>T(E, v), m.onerror = (E)=>{
            c && c(m.src), T(E, w);
        }, m.src += e !== "" ? "&".concat(e) : "", i.appendChild(m);
    });
}
var C = [];
function ge() {
    ...
    try {
        ...
        let r = S(t.scriptLocation), n = R(r), s = C.find((param)=>{
            let { scope: u } = param;
            return u === n.window;
        });
...
//# sourceMappingURL=node_modules_0883cdd5._.js.map