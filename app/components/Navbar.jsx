...
const Navbar = () => {
    ...
    return (
        ...
        >
            ...
            <ul className="hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 bg-opacity-50 text-lg">
            ...
            <div className="flex items-center gap-4">
                ...
                <button className="block md:hidden ml-3" onClick={openMenu}>
                    <img src='/assets/menu-white.png' alt="menu" className="w-6" />
                </button>
            </div>
            ...
            <ul
                ref={sideMenuRef}
                className="flex md:hidden flex-col gap-6 py-24 px-8 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-gradient-to-b from-[#182836] to-[#0e1c2a] text-white  transition-transform duration-500 ease-in-out rounded-l-3xl"
            >
                <div
                    className="absolute right-4 top-4 cursor-pointer p-2 rounded-full bg-white/10 hover:bg-white/20 transition"
                    onClick={closeMenu}
                >
                    <img src='/assets/close-white.png' alt="close" className="w-4" />
                </div>
